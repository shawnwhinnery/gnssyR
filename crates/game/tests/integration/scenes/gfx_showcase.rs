/// GFX showcase scene — exercises every shape primitive, style variant, and
/// transform helper in the vector library.
///
/// Exists purely for automated snapshot testing. Not a production game scene.
...
pub struct GfxShowcaseScene;

impl Scene for GfxShowcaseScene {
    fn tick(&mut self, _events: &[InputEvent]) -> Option<SceneTransition> {
        None
    }
